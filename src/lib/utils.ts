...
export function calculateProfileCompletion(data: Partial<Member>): {
  ...
  const fields: { key: keyof Member; label: string; weight: number }[] = [
    ...
    { key: 'villageTown', label: 'Village / Town', weight: 8 },
    { key: 'district', label: 'District', weight: 5 },
    { key: 'postOffice', label: 'Post Office', weight: 4 },
    { key: 'policeStation', label: 'Police Station', weight: 4 },
    { key: 'city', label: 'City', weight: 4 },
